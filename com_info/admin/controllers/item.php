...
class InfoControllerItem extends FormController
{
	/**
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_INFO_ITEM';
	...
	public function updateImages()
	{
		...
		if (!empty($id) & !empty($field))
		{
			...
			$helper = new imageFolderHelper('images/info');
			$helper->saveImagesValue($id, '#__info', $field, $value);
		}
